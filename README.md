...
- [**nix-init**](https://github.com/nix-community/nix-init) (⭐ 1171) - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more
- [**fenix**](https://github.com/nix-community/fenix) (⭐ 902) - Rust toolchains and rust-analyzer nightly for Nix
- [**nurl**](https://github.com/nix-community/nurl) (⭐ 615) - Generate Nix fetcher calls from repository URLs
- [**haumea**](https://github.com/nix-community/haumea) (⭐ 365) - Filesystem-based module system for Nix
...
- [**nixpkgs**](https://github.com/nixos/nixpkgs) (⭐ 22028) - Nix Packages collection & NixOS
- [**ouch**](https://github.com/ouch-org/ouch) (⭐ 3211) - Painless compression and decompression in the terminal
- [**nix-index**](https://github.com/nix-community/nix-index) (⭐ 1108) - Quickly locate nix packages with specific files
- [**nix-update**](https://github.com/mic92/nix-update) (⭐ 665) - Swiss-knife for updating nix packages.
- [**nixpkgs-review**](https://github.com/mic92/nixpkgs-review) (⭐ 535) - Review pull-requests on https://github.com/NixOS/nixpkgs
...
<sub>Last updated: 2025-10-11 18:23:54 UTC</sub>
