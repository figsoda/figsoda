...
- [**nix-init**](https://github.com/nix-community/nix-init) (⭐ 1158) - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more
- [**fenix**](https://github.com/nix-community/fenix) (⭐ 898) - Rust toolchains and rust-analyzer nightly for Nix
- [**nurl**](https://github.com/nix-community/nurl) (⭐ 611) - Generate Nix fetcher calls from repository URLs
- [**haumea**](https://github.com/nix-community/haumea) (⭐ 364) - Filesystem-based module system for Nix
- [**nix-melt**](https://github.com/nix-community/nix-melt) (⭐ 281) - A ranger-like flake.lock viewer
- [**namaka**](https://github.com/nix-community/namaka) (⭐ 128) - Snapshot testing for Nix based on haumea
- [**mmtc**](https://github.com/figsoda/mmtc) (⭐ 101) - Minimal mpd terminal client that aims to be simple yet highly configurable
- [**zon2nix**](https://github.com/nix-community/zon2nix) (⭐ 101) - Convert the dependencies in `build.zig.zon` to a Nix expression
...
- [**nixpkgs**](https://github.com/nixos/nixpkgs) (⭐ 21946) - Nix Packages collection & NixOS
- [**ouch**](https://github.com/ouch-org/ouch) (⭐ 3194) - Painless compression and decompression in the terminal
- [**nix-index**](https://github.com/nix-community/nix-index) (⭐ 1100) - Quickly locate nix packages with specific files
- [**nix-update**](https://github.com/mic92/nix-update) (⭐ 663) - Swiss-knife for updating nix packages.
- [**nixpkgs-review**](https://github.com/mic92/nixpkgs-review) (⭐ 534) - Review pull-requests on https://github.com/NixOS/nixpkgs
...
<sub>Last updated: 2025-10-04 20:19:27 UTC</sub>
