...
- [**nix-init**](https://github.com/nix-community/nix-init) (⭐ 1107) - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more
- [**fenix**](https://github.com/nix-community/fenix) (⭐ 868) - Rust toolchains and rust-analyzer nightly for Nix
- [**nurl**](https://github.com/nix-community/nurl) (⭐ 585) - Generate Nix fetcher calls from repository URLs
- [**haumea**](https://github.com/nix-community/haumea) (⭐ 357) - Filesystem-based module system for Nix
- [**nix-melt**](https://github.com/nix-community/nix-melt) (⭐ 276) - A ranger-like flake.lock viewer
...
- [**nixpkgs**](https://github.com/nixos/nixpkgs) (⭐ 21480) - Nix Packages collection & NixOS
- [**ouch**](https://github.com/ouch-org/ouch) (⭐ 3034) - Painless compression and decompression in the terminal
- [**nix-index**](https://github.com/nix-community/nix-index) (⭐ 1067) - Quickly locate nix packages with specific files
- [**nix-update**](https://github.com/mic92/nix-update) (⭐ 635) - Swiss-knife for updating nix packages.
- [**nixpkgs-review**](https://github.com/mic92/nixpkgs-review) (⭐ 516) - Review pull-requests on https://github.com/NixOS/nixpkgs
...
<sub>Last updated: 2025-08-16 19:15:47 UTC</sub>
