...
- [**nix-init**](https://github.com/nix-community/nix-init) (⭐ 1115) - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more
- [**fenix**](https://github.com/nix-community/fenix) (⭐ 874) - Rust toolchains and rust-analyzer nightly for Nix
- [**nurl**](https://github.com/nix-community/nurl) (⭐ 593) - Generate Nix fetcher calls from repository URLs
...
- [**nixpkgs**](https://github.com/nixos/nixpkgs) (⭐ 21599) - Nix Packages collection & NixOS
- [**ouch**](https://github.com/ouch-org/ouch) (⭐ 3104) - Painless compression and decompression in the terminal
- [**nix-index**](https://github.com/nix-community/nix-index) (⭐ 1070) - Quickly locate nix packages with specific files
- [**nix-update**](https://github.com/mic92/nix-update) (⭐ 636) - Swiss-knife for updating nix packages.
- [**nixpkgs-review**](https://github.com/mic92/nixpkgs-review) (⭐ 522) - Review pull-requests on https://github.com/NixOS/nixpkgs
...
<sub>Last updated: 2025-08-25 18:30:36 UTC</sub>
